...
class Email extends LoggerNotify
{
     ...
     */
    final public function __construct($title, PHPMailer $PHPMailer)
    {
     ...
     */
    final private function formatContext(array $context)
    {
        $panel = '';
     ...
     */
    final private function formatValues($value)
    {
        if (!is_array($value)) {
            return $value;
        }
